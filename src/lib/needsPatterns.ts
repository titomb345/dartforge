...
export const HUNGER_LEVELS: NeedLevel[] = [
  ...
  { key: 'slightly-hungry', label: 'Slightly Hungry', descriptor: 'slightly hungry', themeColor: 'yellow', severity: 2 },
  ...
  { key: 'faint-hunger', label: 'Faint from Hunger', descriptor: 'faint from hunger', themeColor: 'yellow', severity: 5 },
...
export const THIRST_LEVELS: NeedLevel[] = [
  ...
  { key: 'slightly-thirsty', label: 'Slightly Thirsty', descriptor: 'slightly thirsty', themeColor: 'yellow', severity: 2 },
  ...
  { key: 'faint-thirst', label: 'Faint from Thirst', descriptor: 'faint from thirst', themeColor: 'yellow', severity: 5 },
