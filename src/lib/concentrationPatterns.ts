...
export const CONCENTRATION_LEVELS: ConcentrationLevel[] = [
  ...
  { key: 'qd', label: 'Quite Distracted', message: "You're quite distracted.", themeColor: 'yellow', severity: 3 },
  { key: 'ob', label: 'Off Balance', message: "You're off balance.", themeColor: 'yellow', severity: 4 },
