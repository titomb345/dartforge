...
export const AURA_LEVELS: AuraLevel[] = [
  {
    key: 'scintillating',
    label: 'Scintillating',
    descriptor: 'scintillating',
    themeColor: 'brightWhite',
    severity: 0,
    color: '#ffffff',
  },
  {
    key: 'intense-octarine',
    label: 'Intense Octarine',
    descriptor: 'intense octarine',
    themeColor: 'brightCyan',
    severity: 1,
    color: '#e0b0ff',
  },
  {
  ...
  {
    key: 'intense-violet',
    label: 'Intense Violet',
    descriptor: 'intense violet',
    themeColor: 'brightMagenta',
    severity: 4,
    color: '#d070ff',
  },
  {
  ...
  {
    key: 'orangish-yellow',
    label: 'Orangish-Yellow',
    descriptor: 'orangish-yellow',
    themeColor: 'brightYellow',
    severity: 18,
    color: '#e0b020',
  },
  {
    key: 'yellowish-orange',
    label: 'Yellowish-Orange',
    descriptor: 'yellowish-orange',
    themeColor: 'brightYellow',
    severity: 19,
    color: '#e09020',
  },
  ...
  },
  {
    ...
    descriptor: 'reddish-orange',
    themeColor: 'brightRed',
    severity: 21,
    color: '#e04020',
  },
  {
