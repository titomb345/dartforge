...
export const AURA_LEVELS: AuraLevel[] = [
  ...
  { key: 'orangish-yellow', label: 'Orangish-Yellow', descriptor: 'orangish-yellow', themeColor: 'brightYellow', severity: 18, color: '#e0b020' },
  { key: 'yellowish-orange', label: 'Yellowish-Orange', descriptor: 'yellowish-orange', themeColor: 'brightYellow', severity: 19, color: '#e09020' },
  { key: 'orange', label: 'Orange', descriptor: 'orange', themeColor: 'brightYellow', severity: 20, color: '#e07020' },
