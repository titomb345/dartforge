...
export function CollapseIcon({ size = 12 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function MacroIcon({ size = 16 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function HexGridIcon({ size = 16 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function HouseIcon({ size = 16 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function LoadoutIcon({ size = 16 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function EyeOffIcon({ size = 12 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
